...
export const students = [
  { id: 1, nama: 'Anita', nilai: 89 },
  { id: 2, nama: 'Hermawan', nilai: 82 },
  { id: 3, nama: 'Adinda', nilai: 95 }
];

export const lessons = [
  { id: 'coba01', title: 'Variabel & JSX', description: 'Pengenalan struktur React, JSX, dan penggunaan variabel.' },
  { id: 'coba02', title: 'Component & Styling', description: 'Functional component, class component, inline style, dan CSS.' },
  { id: 'coba02c', title: 'Props & Array', description: 'Membuat komponen reusable dengan props dan map array.' },
  { id: 'coba03', title: 'Event Handler', description: 'Menangani aksi pengguna menggunakan onClick.' },
  { id: 'coba03b', title: 'React State', description: 'Mengelola data dinamis dengan useState.' },
  { id: 'coba03c', title: 'Conditional', description: 'Menampilkan UI berdasarkan kondisi state.' },
  { id: 'coba04', title: 'Keranjang Produk', description: 'Project onClick, useState, conditional, dan quantity.' },
